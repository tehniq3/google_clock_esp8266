...
// =======================================================================
const char* ssid     = "wifi_name";              // SSID WiFi nam
...
void setup() 
{
  ...
  printStringWithShift("Google clock.......v.1.e......",38);
...
{  
  ...
  if(millis()-clkTime > 30000 && !del && dots) 
  {
    ...
    derece += an;
    derece += "             ";
    char Buf[51]; //    char Buf[8];
    derece.toCharArray(Buf,51); // derece.toCharArray(Buf,8);
    
    printStringWithShift(Buf,51);
    delay(200);
    updCnt--;
    clkTime = millis();
}
