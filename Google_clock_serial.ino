 ...
 * Print the result over serial, Copyright (c) 2018 by Dave Waldesbuehl
 * Nicu FLORICA (niq_ro) test the google clock + date
*/
...
// WiFi settings
const char* SSID     = "network_name";              // The SSID of your WiFi accesspoint
const char* PASSWORD = "network_pass";       		  // password for your WiFi accesspoint

// Http settings
const char SERVER[30] = "www.google.com";	  // Every host is possible
String COMMAND ="https://www.google.com/";     // Every site or API request is possible
const int SSL_PORT = 80; //443;                     // Use port 80 for non secure connection

// Time settings
const int TIMEZONE = 2;                       // +/- Timezone offset to GMT. e.g. 1 for MEZ, 0 for GMT
...
static char *weekday[7] = {"Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"};
