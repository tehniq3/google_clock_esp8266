...
v.1.h - added DST (summer/winter time) using info from https://www.timeanddate.com/time/change/germany and in special from https://www.instructables.com/WiFi-NodeMCU-ESP8266-Google-Clock/
*/
...
// =======================================================================
const char* ssid     = "bbk32";              // SSID WiFi nam
const char* password = "internet3";         // WiFi password

float utcOffset = 2;                        // Timezone offset (in hour)
byte format1224 = 24;                       // 12/24,  12 -hour format or 24-hour format
// =======================================================================
...
void setup() 
{
  ...
  printStringWithShift("Google clock.......v.1.h......",38);
